...
with Diagram('mapperqak22Arch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
     ...
     mapperqak22 >> Edge(color='magenta', style='solid', xlabel='step', fontcolor='magenta') >> basicrobot
     mapperqak22 >> Edge(color='blue', style='solid', xlabel='cmd', fontcolor='blue') >> basicrobot
diag
