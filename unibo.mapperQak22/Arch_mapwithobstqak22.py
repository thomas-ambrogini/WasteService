...
with Diagram('mapwithobstqak22Arch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
     ...
     mapwithobstqak22 >> Edge(color='magenta', style='solid', xlabel='step', fontcolor='magenta') >> basicrobot
     mapwithobstqak22 >> Edge(color='blue', style='solid', xlabel='cmd', fontcolor='blue') >> basicrobot
diag
