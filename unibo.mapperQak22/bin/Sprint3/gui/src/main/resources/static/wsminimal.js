...
function connect() {
    ...
    socket.onmessage = function (event) {
        ...
        else if (msg.includes("position")) setMessageToWindow(trolleyPositionDisplay, msg);
        else if (msg.includes("plastic")) setMessageToWindow(plasticBoxDisplay, msg);
        else if (msg.includes("glass")) setMessageToWindow(glassBoxDisplay, msg);
