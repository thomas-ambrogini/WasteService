		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t029",targetState="handleRequest",cond=whenRequest("storeRequest"))
					transition(edgeName="t030",targetState="handleAsk",cond=whenRequest("storageAsk"))
					transition(edgeName="t031",targetState="handleUpdate",cond=whenDispatch("updateWeights"))
				}	 
