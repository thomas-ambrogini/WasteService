		...
		return { //this:ActionBasciFsm
				state("home") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t032",targetState="moveTrolleyIndoor",cond=whenRequest("startDeposit"))
				}	 
				state("moveTrolleyIndoor") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t233",targetState="handlepickup",cond=whenReply("destinationReached"))
				}	 
				state("handlepickup") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1134",targetState="handle_pickupDone",cond=whenReply("pickupDone"))
				}	 
				...
				state("moveTrolleyContainer") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t435",targetState="handleDeposit",cond=whenReply("destinationReached"))
				}	 
				state("handleDeposit") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1136",targetState="handle_depositDone",cond=whenReply("depositDone"))
				}	 
				state("handle_depositDone") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t537",targetState="moveTrolleyHome",cond=whenTimeout("local_tout_wasteservice_handle_depositDone"))   
					transition(edgeName="t538",targetState="moveTrolleyIndoor",cond=whenRequest("startDeposit"))
				}	 
				state("moveTrolleyHome") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1239",targetState="home",cond=whenReply("destinationReached"))
				}	 
			}
		}
}
