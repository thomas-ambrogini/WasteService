	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				state("init") { //this:State
					action { //it:State
						CoapObserverSupport(myself, "localhost","8049","ctx_wasteservice","transporttrolley_mover")
						CoapObserverSupport(myself, "localhost","8049","ctx_wasteservice","wasteservice")
