	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("idle") { //this:State
					...
					transition(edgeName="t09",targetState="findThePath",cond=whenRequest("findPath"))
				}	 
				state("findThePath") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t110",targetState="savepath",cond=whenDispatch("stop"))
					transition(edgeName="t111",targetState="pathDone",cond=whenReply("dopathdone"))
					transition(edgeName="t112",targetState="handle_resume",cond=whenReply("dopathfail"))
				}	 
				...
				state("stopped") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t713",targetState="handle_resume",cond=whenDispatch("resume"))
				}	 
				state("handle_resume") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t214",targetState="stopped",cond=whenDispatch("stop"))
					transition(edgeName="t215",targetState="pathDone",cond=whenReply("dopathdone"))
					transition(edgeName="t216",targetState="handle_resume",cond=whenReply("dopathfail"))
				}	 
			}
		}
}
